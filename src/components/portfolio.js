                    ...
                    <div class="col-md-8">
                        <div class="jumbotron jumbotron-fluid mt-5 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-2 one">
                                I am Balaji Sai. Computer Science Student passionate to work in a competitive environment where I can showcase my
                                technical skills. </p>
                            </div>
                        </div>
                        ...
                        <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                <h3 class="p-2">Contact Me: <a href="mailto:balaji@gmail.com">Email</a> <a href="LinkedInProfile">LinkedIn</a> +91 9182343490</h3>
                            </div>
                        </div>
                    </div>
                </div>
